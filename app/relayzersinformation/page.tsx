...
const page = () => {
    return (
        <div>
            ...
            <Grid container justifyContent={'space-around'} marginY={10}>
                <Box width={200} height={200}>
                    <div className='rounded-3xl shadow-2xl transition-all hover:shadow-green-400'>
                        <Link href="tel:+994706789125"><FaWhatsapp className='p-14 mx-10 text-9xl transition-all hover:p-10  ' /></Link>
                    </div>
                </Box>
                <Box width={200} height={200}>
            ...
            <Typography className='text-4xl font-bold mt-10 text-center'><Link href="/"><Image src="/store/applelogoblack.svg" alt="" width={100} height={100} className='mx-auto' /></Link></Typography>
            <Typography className='text-4xl font-bold my-20 text-center'>Thank You Support</Typography>
